...
export const PWAInstallPrompt: React.FC = () => {
  ...
  return (
    <div className="fixed bottom-4 left-4 right-4 bg-white border border-gray-200 rounded-xl shadow-lg p-4 z-50 lg:bottom-6 lg:left-6 lg:right-auto lg:max-w-sm">
